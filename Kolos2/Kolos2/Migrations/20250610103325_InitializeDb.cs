    ...
    public partial class InitializeDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 6, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), "Lisbon", "MAgnificicent race" },
                    { 2, new DateTime(2025, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "Grochow", "Even better race" }
                });
